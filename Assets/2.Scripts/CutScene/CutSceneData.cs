...
// summary: 컷씬의 데이터를 저장하는 역할(ScriptableObject 사용)
...
public class CutSceneAction
{
    ...
    public int index;                     // 출력할 대사, 혹은 조작할 컷씬 패널의 인덱스
    public float waitseconds = 0f;        // 액션 후 대기시간
...
public class CutSceneData : ScriptableObject
{
    ...
    [SerializeField] private CutSceneCategory category = CutSceneCategory.Prologue;
    ...
    public CutSceneCategory Category => category;
}