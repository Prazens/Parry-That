...
public class TutorialManager : MonoBehaviour
{
    ...
    private IEnumerator Daehwa4()
    {
        ...
        yield return StartCoroutine(dialogueManager.ShowDialogue(CharacterSprite[4], "소리", Daehwa4_Text1, false));

        string Daehwa4_Text2 = "그건 이 지역에 남은 마지막 소리입니다.\n용사님께서 저들을 해방시키지 못하면 그마저도 날아갈 겁니다!";
        yield return StartCoroutine(dialogueManager.ShowDialogue(CharacterSprite[1], "정령", Daehwa4_Text2, true));
